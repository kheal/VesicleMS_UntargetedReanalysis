...
Datfile1 <- "Intermediates/Targeted_QE_fromLauraC/CyanoAq-Pos_ProVesicles_QE.csv"
...
StdFlag <- c("170127_Std_250nM_StdsInH2O_2", "170127_Std_250nM_StdsInH2O_1", "170128_Std_250nM_StdsInAqMatrix_1", "170128_Std_250nM_StdsInAqMatrix_2")
...
compounds.to.dump <- c("Carotene", "Vitamin K1", "Glutathione Disulfide")

#What's your output file name?
fileout <- "Intermediates/QCd_Tar_RPAq.csv"
